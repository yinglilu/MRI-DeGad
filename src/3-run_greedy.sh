...
for sub in ${sub_list}; do
        ...
        greedy -d 3 -dof 6 -rf ${input_nongad_dir}/${sub}/${sub}_acq-nongad_resampled_T1w.nii.gz  -rm ${input_nongad_dir}/${sub}/${sub}_acq-nongad_resampled_T1w.nii.gz  ${output_dir}/${sub}/${sub}_acq-nongad_desc-rigid_resliced_T1w.nii.gz -r ${output_dir}/${sub}/${sub}_from_nongad_to_gad_rigid.mat
